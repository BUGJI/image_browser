export default {
  ...
  roots: {
    ...
    writable: 'Writable',
    writableTip:
      'When read-only, no writes (e.g. building cache) are allowed on the remote root; existing remote cache can still be downloaded for browsing.',
